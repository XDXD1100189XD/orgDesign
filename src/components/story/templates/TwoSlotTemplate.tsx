...
export function TwoSlotTemplate({ slide, onSlotClick, onRemoveBlock, onSlotDrop, isDragActive }: Props) {
  const slotHeight = 416;
  ...
  return (
    <div style={{ width: 960, height: 540, display: 'flex', flexDirection: 'column', background: '#fff', fontFamily: 'inherit' }}>
      ...
      <div style={{ flex: 1, display: 'flex', gap: 12, padding: '12px 24px', overflow: 'hidden' }}>
